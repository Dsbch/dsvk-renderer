...
// PIXEL SHADER START.
Texture2D accum : register(t12, space0);
SamplerState accumSampler : register(s12, space0);
Texture2D reveal : register(t13, space0);
SamplerState revealSampler : register(s13, space0);
