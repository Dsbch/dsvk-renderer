...
namespace engine
{
	...
	std::pair<const std::shared_ptr<texture>, core::error> assetManager::getTexture(const std::string& id)
	{
	...
	std::pair<const std::shared_ptr<shaderProgram>, core::error> assetManager::getCompiledShader(const std::string& id)
	{
	...
	std::pair<const std::shared_ptr<texture>, core::error> assetManager::loadTexture(const std::string& path)
	{
	...
	std::pair<const std::shared_ptr<shaderProgram>, core::error> assetManager::loadAndCompileShader(const std::string& vertexShaderPath, const std::string& fragmentShaderPath)
	{
