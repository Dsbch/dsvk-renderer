...
namespace engine
{
	...
	std::string vulkanRenderer::getVersion() const
	{
		...
		return fmt::format("VULKAN VERSION: {}", apiVersion);
	}
	...
	void vulkanRenderer::changeViewPort(uint32_t width, uint32_t height)
	{
		...
		// TODO: add call to defualt camera.
	}
	...
	{
		// TODO: figure out how to deal with different shaders.
	}
	...
	void vulkanRenderer::setGraphicsDescriptorBindings()
	{
		// TODO: set pixel and mesh descriptors.
	}
